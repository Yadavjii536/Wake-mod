...
TOKEN = '7306723947:AAFYDL9nrOUnuD0b-4fwAjoqOaCtd3-Qs3o'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -100217382696
CHANNEL_ID = --1002173826961
error_channel_id = --1002173826961
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/WAKE_MOD_73*", parse_mode='Markdown')
